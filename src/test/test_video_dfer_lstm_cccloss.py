...
# NOTE: this is needed to load the weights
...
if __name__ == "__main__":
    ...
    model_path = "./model/former_dfer_1.pth"
    # iresnet100 net, trained on MSM1 face for 360000 iterations
    backbone = FormerDfer()
