...
path.append("./")
from src.models.sfnet import sfnet64
...
model_name = 'lstm_sfnet64_MS1M_correcttanh'
loss_type = 'cccloss'
...
if __name__ == "__main__":
    ...
    train_data_path: str = (
        "/data/leonardo/OMGEmotionChallenge/Train_Set/trimmed_faces"
    )
    device: str = 'cuda:0' if use_cuda else ('mps' if use_mps else 'cpu')
    validation_data_path: str = "/data/leonardo/OMGEmotionChallenge/Validation_Set/trimmed_faces"
    
    model_path = "./model/sphere64+_MS1M.pth"
